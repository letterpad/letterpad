                    ...
                    s &&
                        ...
                        /pre/i.test(s.nodeName) &&
                            (s.className =
                                ...
                                l);
                    var u = a.textContent,
                        c = { element: a, language: l, grammar: o, code: u };
                    if (
                        (u && (c.code = u.replace(/^(?:\r?\n|\r)/, "")),
                        !u || !o)
                    )
                        return t.hooks.run("complete", c), void 0;
                    if (
                        (t.hooks.run("before-highlight", c), r && _self.Worker)
                    ) {
                        var g = new Worker(t.filename);
                        (g.onmessage = function(e) {
                            (c.highlightedCode = n.stringify(
                                JSON.parse(e.data),
                                l
                            )),
