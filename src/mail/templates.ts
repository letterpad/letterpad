...
function getTemplate(name, body, action = "", footer = "") {
  const callToAction = `<table role="presentation" border="0" cellpadding="0" cellspacing="0" class="btn btn-primary">
    <tbody>
      <tr>
        <td align="left">
