...
> = {
  ...
  rows?: Resolver<
    Array<Maybe<ResolversTypes["Media"]>>,
    ParentType,
    ContextType
  >;
};
...
> = {
  ...
  taxonomies?: Resolver<
    Maybe<Array<Maybe<ResolversTypes["Taxonomy"]>>>,
    ParentType,
    ContextType
  >;
};

export type PostNodeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["PostNode"] = ResolversParentTypes["PostNode"]
> = {
  count?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
...
> = {
  ...
  >;
  posts?: Resolver<
    ResolversTypes["PostNode"],
    ParentType,
    ContextType,
    QueryPostsArgs
  >;
  menuContent?: Resolver<
    Maybe<ResolversTypes["PostTaxonomyNode"]>,
    ParentType,
    ContextType,
    QueryMenuContentArgs
  >;
  postsByTaxinomySlug?: Resolver<
    Maybe<ResolversTypes["PostTaxonomyNode"]>,
    ParentType,
    ContextType,
    RequireFields<QueryPostsByTaxinomySlugArgs, "type" | "slug">
  >;
  ...
  taxonomies?: Resolver<
    ...
    QueryTaxonomiesArgs
  >;
  activeTaxonomies?: Resolver<
    Array<Maybe<ResolversTypes["Taxonomy"]>>,
    ParentType,
    ContextType,
    QueryActiveTaxonomiesArgs
  >;
  themes?: Resolver<
