...
INSERT INTO "new_Author" ("avatar", "bio", "company_name", "createdAt", "email", "first_post_published", "id", "last_seen", "login_type", "name", "occupation", "password", "profile_updated", "register_step", "role_id", "settings_updated", "signature", "social", "updatedAt", "username", "verified", "verify_attempt_left") SELECT "avatar", "bio", "company_name", "createdAt", "email", "first_post_published", "id", "last_seen", "login_type", "name", "occupation", "password", "profile_updated", "register_step", "role_id", "settings_updated", "signature", "social", "updatedAt", "username", "verified", "verify_attempt_left" FROM "Author";
DROP TABLE "Author";
...
INSERT INTO "new_Post" ("author_id", "cover_image", "cover_image_height", "cover_image_width", "createdAt", "excerpt", "exclude_from_home", "featured", "html", "html_draft", "id", "mail_status", "page_data", "page_type", "publishedAt", "reading_time", "scheduledAt", "slug", "stats", "status", "sub_title", "title", "type", "updatedAt") SELECT "author_id", "cover_image", "cover_image_height", "cover_image_width", "createdAt", "excerpt", "exclude_from_home", "featured", "html", "html_draft", "id", "mail_status", "page_data", "page_type", "publishedAt", "reading_time", "scheduledAt", "slug", "stats", "status", "sub_title", "title", "type", "updatedAt" FROM "Post";
DROP TABLE "Post";
