...
INSERT INTO "new_Setting" ("author_id", "banner", "client_token", "cloudinary_key", "cloudinary_name", "cloudinary_secret", "createdAt", "css", "display_author_info", "graphcomment_id", "id", "intro_dismissed", "menu", "show_about_page", "show_tags_page", "site_description", "site_email", "site_favicon", "site_footer", "site_logo", "site_tagline", "site_title", "site_url", "social_facebook", "social_github", "social_instagram", "social_twitter", "subscribe_embed", "theme", "updatedAt") SELECT "author_id", "banner", "client_token", "cloudinary_key", "cloudinary_name", "cloudinary_secret", "createdAt", "css", "display_author_info", "graphcomment_id", "id", "intro_dismissed", "menu", "show_about_page", "show_tags_page", "site_description", "site_email", "site_favicon", "site_footer", "site_logo", "site_tagline", "site_title", "site_url", "social_facebook", "social_github", "social_instagram", "social_twitter", "subscribe_embed", "theme", "updatedAt" FROM "Setting";
DROP TABLE "Setting";
