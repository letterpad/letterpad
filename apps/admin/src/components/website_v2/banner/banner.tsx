  ...
  return (
    <div className="w-full pb-10 py-10 md:py-20 bg-gradient-to-b from-slate-950 to-slate-900 text-white relative h-full">
      <Particles
        ...
        quantity={particles}
      />
      <div className="mx-auto max-w-6xl px-4 sm:px-6 justify-between flex-col md:flex-row flex md:items-center md:space-y-0 space-y-10 font-paragraph min-h-40 z-10 relative">
