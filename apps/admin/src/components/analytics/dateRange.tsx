  ...
  return (
    ...
    >
      <option
        ...
        selected={selectedOption === DateRangeEnum.today}
      >
        Today
      </option>
      <option
        value={DateRangeEnum.yesterday}
        selected={selectedOption === DateRangeEnum.yesterday}
      >
        Yesterday
      </option>
      <option
      ...
      <option
        value={DateRangeEnum.last30Days}
        selected={selectedOption === DateRangeEnum.last30Days}
      >
        Last 30 days
      </option>
      <option
        value={DateRangeEnum.last90Days}
        selected={selectedOption === DateRangeEnum.last90Days}
      >
        Last 90 days
      </option>
    </select>
