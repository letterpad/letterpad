...
export type PostQuery = { __typename?: 'Query', post: { __typename: 'Exception', message: string } | { __typename: 'InvalidArguments', message: string } | { __typename: 'NotFound', message: string } | { __typename: 'Post', id: number, slug?: string | null, title: string, sub_title?: string | null, reading_time?: string | null, page_type?: string | null, page_data?: string | null, html?: string | null, type: PostTypes, publishedAt?: any | null, updatedAt: any, excerpt?: string | null, stats?: { __typename?: 'PostStats', words?: number | null, reading_time?: number | null, characters?: number | null, spaceless_characters?: number | null } | null, tags?: { __typename: 'Exception', message: string } | { __typename: 'TagsNode', rows: Array<{ __typename?: 'Tag', name: string, slug: string }> } | { __typename: 'UnAuthorized', message: string } | null, author?: { __typename: 'Author', id: number, name: string, avatar?: string | null, occupation?: string | null, bio?: string | null } | { __typename: 'Exception', message: string } | { __typename: 'Failed', message: string } | { __typename: 'NotFound', message: string } | { __typename: 'UnAuthorized', message: string } | null, cover_image: { __typename?: 'Image', src?: string | null, width?: number | null, height?: number | null } } | { __typename: 'UnAuthorized', message: string } };

export type PageFragmentFragment = { __typename?: 'Post', id: number, slug?: string | null, title: string, sub_title?: string | null, reading_time?: string | null, page_type?: string | null, page_data?: string | null, html?: string | null, type: PostTypes, publishedAt?: any | null, updatedAt: any, excerpt?: string | null, stats?: { __typename?: 'PostStats', words?: number | null, reading_time?: number | null, characters?: number | null, spaceless_characters?: number | null } | null, tags?: { __typename: 'Exception', message: string } | { __typename: 'TagsNode', rows: Array<{ __typename?: 'Tag', name: string, slug: string }> } | { __typename: 'UnAuthorized', message: string } | null, author?: { __typename: 'Author', id: number, name: string, avatar?: string | null, occupation?: string | null, bio?: string | null } | { __typename: 'Exception', message: string } | { __typename: 'Failed', message: string } | { __typename: 'NotFound', message: string } | { __typename: 'UnAuthorized', message: string } | null, cover_image: { __typename?: 'Image', src?: string | null, width?: number | null, height?: number | null } };
...
export type TagsQuery = { __typename?: 'Query', tags: { __typename: 'Exception', message: string } | { __typename: 'TagsNode', rows: Array<{ __typename?: 'Tag', name: string, slug: string, posts?: { __typename: 'Exception' } | { __typename: 'PostsNode', count: number } | { __typename: 'UnAuthorized' } | null }> } | { __typename: 'UnAuthorized', message: string } };
