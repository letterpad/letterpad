    ...
    render() {
                    ...
                    >
                        <div className="menu_section">
                            ...
                            <ul className="nav side-menu">
                                ...
                                <li>
                                    <a>
                                        <i className="fa fa-edit" /> Media{" "}
                                        <span className="fa fa-chevron-down" />
                                    </a>
                                </li>
                                <li>
                                    <a>
                                        <i className="fa fa-edit" /> Settings{" "}
                                        <span className="fa fa-chevron-down" />
                                    </a>
                                    <ul className="nav child_menu">
                                        <li>
        ...
        return (
            ...
            >
                <ul className="nav">
                    <li>
                        <Link to="/connections" className="active">
                            Connections
                        </Link>
                    </li>
                    <li>
